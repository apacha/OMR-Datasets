...
class MuscimaPlusPlusMaskImageGenerator:
    ...
    def render_node_masks(self, raw_data_directory: str, destination_directory: str, mask_type: MaskType):
        ...
        node_classes = parse_node_classes(
            os.path.join(raw_data_directory,  "mff-muscima-mlclasses-annot.xml"))
    ...
    def __get_all_file_paths(self, raw_data_directory: str) -> List[Tuple[str, str]]:
        ...
        """
        annotations_directory = os.path.join(raw_data_directory, "raw_data", "annotations")
        xml_files = sorted([y for x in os.walk(annotations_directory) for y in glob(os.path.join(x[0], '*.xml'))])
        images_directory = os.path.join(raw_data_directory, "raw_data", "images")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/Users/elona/Documents/GitHub/dataloader/OMR-Datasets/omrdatasettools",
        help="The directory, where the raw Muscima++ dataset can be found")
    parser.add_argument(
        "--image_dataset_directory",
        type=str,
        default="/Users/elona/Documents/GitHub/dataloader/OMR-Datasets/omrdatasettools/masks",
