...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/Users/elona/Documents/GitHub/dataloader/OMR-Datasets/omrdatasettools/raw_data",
        help="The directory, where the Muscima++ dataset can be found. Must be at least version 2.0.")
    parser.add_argument(
        "--image_dataset_directory",
        type=str,
        default="/Users/elona/Documents/GitHub/dataloader/OMR-Datasets/omrdatasettools/raw_data/symbols",
